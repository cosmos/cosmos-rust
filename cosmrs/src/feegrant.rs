...
// TODO: prost-types needs a new release that includes https://github.com/tokio-rs/prost/pull/625
// for DurationError support
...
//         PeriodicAllowance::try_from(&proto)
//     }
// }
...
//         proto::cosmos::feegrant::v1beta1::PeriodicAllowance::from(&allowance)
//     }
// }
...
//             period: allowance.period.map(Into::into),

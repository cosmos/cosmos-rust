...
impl serde::Serialize for GasInfo {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            ...
            struct_ser.serialize_field("gasWanted", ::alloc::string::ToString::to_string(&self.gas_wanted).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
...
impl serde::Serialize for SearchTxsResult {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("totalCount", ::alloc::string::ToString::to_string(&self.total_count).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("count", ::alloc::string::ToString::to_string(&self.count).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("pageNumber", ::alloc::string::ToString::to_string(&self.page_number).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("pageTotal", ::alloc::string::ToString::to_string(&self.page_total).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]

...
impl<'de> serde::Deserialize<'de> for Capability {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<Capability, V::Error>
                where
...
impl<'de> serde::Deserialize<'de> for CapabilityOwners {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<CapabilityOwners, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for GenesisOwners {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GenesisOwners, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut index__ = None;
...
impl<'de> serde::Deserialize<'de> for Owner {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<Owner, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {

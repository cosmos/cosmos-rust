...
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            ...
            struct_ser.serialize_field("blocksPerYear", ::alloc::string::ToString::to_string(&self.blocks_per_year).as_str())?;
        }
        struct_ser.end()
    }
}
...
impl<'de> serde::Deserialize<'de> for QueryAnnualProvisionsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryAnnualProvisionsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
...
impl<'de> serde::Deserialize<'de> for QueryAnnualProvisionsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryAnnualProvisionsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut annual_provisions__ = None;
...
impl<'de> serde::Deserialize<'de> for QueryInflationRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryInflationRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
...
impl<'de> serde::Deserialize<'de> for QueryInflationResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryInflationResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut inflation__ = None;

...
impl<'de> serde::Deserialize<'de> for ModuleSchemaDescriptor {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<ModuleSchemaDescriptor, V::Error>
                where
...
impl serde::Serialize for module_schema_descriptor::FileEntry {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            let v = StorageType::try_from(self.storage_type)
                .map_err(|_| serde::ser::Error::custom(::alloc::format!("Invalid variant {}", self.storage_type)))?;
...
impl<'de> serde::Deserialize<'de> for module_schema_descriptor::FileEntry {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<module_schema_descriptor::FileEntry, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut id__ = None;

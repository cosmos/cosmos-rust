...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::QueryCommunityPoolResponse>, tonic::Status>
        {
            ...
            let path =
                http::uri::PathAndQuery::from_static("/cosmos.protocolpool.v1.Query/CommunityPool");
        ...
        ) -> core::result::Result<tonic::Response<super::QueryContinuousFundResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> core::result::Result<tonic::Response<super::QueryContinuousFundsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> core::result::Result<tonic::Response<super::QueryParamsResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/cosmos.protocolpool.v1.Query/Params");
            let mut req = request.into_request();
            req.extensions_mut()
...
pub mod query_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/cosmos.protocolpool.v1.Query/ContinuousFund" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryContinuousFundRequest>
                        for ContinuousFundSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as Query>::continuous_fund(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/cosmos.protocolpool.v1.Query/ContinuousFunds" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryContinuousFundsRequest>
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "cosmos.protocolpool.v1.Query";
    }
}
/// Generated client implementations.
#[cfg(feature = "grpc")]
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::MsgUpdateParamsResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/cosmos.protocolpool.v1.Msg/UpdateParams");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "cosmos.protocolpool.v1.Msg",
                "UpdateParams",
...
pub mod msg_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/cosmos.protocolpool.v1.Msg/CreateContinuousFund" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgCreateContinuousFund>
                ...
                "/cosmos.protocolpool.v1.Msg/CancelContinuousFund" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgCancelContinuousFund>
    ...
    impl<T: Msg> tonic::server::NamedService for MsgServer<T> {
        const NAME: &'static str = "cosmos.protocolpool.v1.Msg";
    }
}

...
impl serde::Serialize for StakeAuthorization {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            let v = AuthorizationType::try_from(self.authorization_type)
                .map_err(|_| serde::ser::Error::custom(::alloc::format!("Invalid variant {}", self.authorization_type)))?;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::AuthorizationType => {
                            ...
                            authorization_type__ = Some(map_.next_value::<AuthorizationType>()? as i32);
                        }
...
impl<'de> serde::Deserialize<'de> for stake_authorization::Validators {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<stake_authorization::Validators, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;

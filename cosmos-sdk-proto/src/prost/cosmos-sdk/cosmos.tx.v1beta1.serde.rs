...
impl<'de> serde::Deserialize<'de> for BroadcastTxResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<BroadcastTxResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for Fee {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("gasLimit", ::alloc::string::ToString::to_string(&self.gas_limit).as_str())?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for GetBlockWithTxsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetBlockWithTxsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for GetBlockWithTxsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetBlockWithTxsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut txs__ = None;
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            let v = OrderBy::try_from(self.order_by)
                .map_err(|_| serde::ser::Error::custom(::alloc::format!("Invalid variant {}", self.order_by)))?;
            struct_ser.serialize_field("orderBy", &v)?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("page", ::alloc::string::ToString::to_string(&self.page).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
...
impl<'de> serde::Deserialize<'de> for GetTxsEventResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetTxsEventResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut txs__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Single => {
                            ...
                            sum__ = map_.next_value::<::core::option::Option<_>>()?.map(mode_info::Sum::Single)
;
                        }
                        GeneratedField::Multi => {
                            ...
                            sum__ = map_.next_value::<::core::option::Option<_>>()?.map(mode_info::Sum::Multi)
;
                        }
                    }
                }
...
impl<'de> serde::Deserialize<'de> for TxDecodeAminoRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<TxDecodeAminoRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for TxDecodeAminoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<TxDecodeAminoResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for TxEncodeAminoRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<TxEncodeAminoRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut amino_json__ = None;
...
impl<'de> serde::Deserialize<'de> for TxEncodeAminoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<TxEncodeAminoResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut amino_binary__ = None;

        ...
        if let Some(v) = self.value.as_ref() {
            match v {
                index_value::Value::Uint(v) => {
                    ...
                    struct_ser.serialize_field("uint", ::alloc::string::ToString::to_string(&v).as_str())?;
                }
                index_value::Value::Int(v) => {
                    #[allow(clippy::needless_borrow)]
                    struct_ser.serialize_field("int", ::alloc::string::ToString::to_string(&v).as_str())?;
                }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Uint => {
                            ...
                            value__ = map_.next_value::<::core::option::Option<::pbjson::private::NumberDeserialize<_>>>()?.map(|x| index_value::Value::Uint(x.0));
                        }
                        GeneratedField::Int => {
                            if value__.is_some() {
                                return Err(serde::de::Error::duplicate_field("int"));
                            }
                            value__ = map_.next_value::<::core::option::Option<::pbjson::private::NumberDeserialize<_>>>()?.map(|x| index_value::Value::Int(x.0));
                        }
                        GeneratedField::Str => {
                            if value__.is_some() {
                                return Err(serde::de::Error::duplicate_field("str"));
                            }
                            value__ = map_.next_value::<::core::option::Option<_>>()?.map(index_value::Value::Str);
                        }
                        ...
                        GeneratedField::Enum => {
                            ...
                            value__ = map_.next_value::<::core::option::Option<_>>()?.map(index_value::Value::Enum);
                        }
                        GeneratedField::Bool => {
                            if value__.is_some() {
                                return Err(serde::de::Error::duplicate_field("bool"));
                            }
                            value__ = map_.next_value::<::core::option::Option<_>>()?.map(index_value::Value::Bool);
                        }
                        GeneratedField::Timestamp => {
                            if value__.is_some() {
                                return Err(serde::de::Error::duplicate_field("timestamp"));
                            }
                            value__ = map_.next_value::<::core::option::Option<_>>()?.map(index_value::Value::Timestamp)
;
                        }
                        GeneratedField::Duration => {
                            ...
                            value__ = map_.next_value::<::core::option::Option<_>>()?.map(index_value::Value::Duration)
;
                        }
                    }
                }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Prefix => {
                            ...
                            query__ = map_.next_value::<::core::option::Option<_>>()?.map(list_request::Query::Prefix)
;
                        }
                        GeneratedField::Range => {
                            ...
                            query__ = map_.next_value::<::core::option::Option<_>>()?.map(list_request::Query::Range)
;
                        }
                    }
                }
...
impl<'de> serde::Deserialize<'de> for list_request::Prefix {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<list_request::Prefix, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut values__ = None;
...
impl<'de> serde::Deserialize<'de> for list_request::Range {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<list_request::Range, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {

impl serde::Serialize for BaseVestingAccount {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            ...
            struct_ser.serialize_field("endTime", ::alloc::string::ToString::to_string(&self.end_time).as_str())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for ContinuousVestingAccount {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("startTime", ::alloc::string::ToString::to_string(&self.start_time).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ContinuousVestingAccount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<ContinuousVestingAccount, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for DelayedVestingAccount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<DelayedVestingAccount, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut base_vesting_account__ = None;
...
impl<'de> serde::Deserialize<'de> for MsgCreatePeriodicVestingAccount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgCreatePeriodicVestingAccount, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for MsgCreatePeriodicVestingAccountResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgCreatePeriodicVestingAccountResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for MsgCreatePermanentLockedAccount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgCreatePermanentLockedAccount, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut from_address__ = None;
...
impl<'de> serde::Deserialize<'de> for MsgCreatePermanentLockedAccountResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgCreatePermanentLockedAccountResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
...
impl<'de> serde::Deserialize<'de> for MsgCreateVestingAccount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgCreateVestingAccount, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut from_address__ = None;
...
impl<'de> serde::Deserialize<'de> for MsgCreateVestingAccountResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgCreateVestingAccountResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
...
impl serde::Serialize for Period {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("length", ::alloc::string::ToString::to_string(&self.length).as_str())?;
        }
        if true {
            struct_ser.serialize_field("amount", &self.amount)?;
        }
...
impl<'de> serde::Deserialize<'de> for PeriodicVestingAccount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<PeriodicVestingAccount, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut base_vesting_account__ = None;
...
impl<'de> serde::Deserialize<'de> for PermanentLockedAccount {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<PermanentLockedAccount, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut base_vesting_account__ = None;

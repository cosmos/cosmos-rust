...
impl<'de> serde::Deserialize<'de> for GetBlockByHeightRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetBlockByHeightRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
...
impl<'de> serde::Deserialize<'de> for GetBlockByHeightResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetBlockByHeightResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for GetLatestBlockRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetLatestBlockRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for GetLatestBlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetLatestBlockResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut block_id__ = None;
...
impl<'de> serde::Deserialize<'de> for GetLatestValidatorSetRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetLatestValidatorSetRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for GetLatestValidatorSetResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetLatestValidatorSetResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for GetNodeInfoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetNodeInfoResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Syncing => {
                            ...
                            syncing__ = Some(map_.next_value()?);
                        }
                    }
                }
...
impl<'de> serde::Deserialize<'de> for GetValidatorSetByHeightRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetValidatorSetByHeightRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
...
impl<'de> serde::Deserialize<'de> for GetValidatorSetByHeightResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<GetValidatorSetByHeightResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut block_height__ = None;
...
impl serde::Serialize for Validator {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("votingPower", ::alloc::string::ToString::to_string(&self.voting_power).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("proposerPriority", ::alloc::string::ToString::to_string(&self.proposer_priority).as_str())?;
        }
        struct_ser.end()
    }
}

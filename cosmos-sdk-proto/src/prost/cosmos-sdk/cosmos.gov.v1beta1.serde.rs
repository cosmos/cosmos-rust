...
impl serde::Serialize for DepositParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.DepositParams", len)?;
        if !self.min_deposit.is_empty() {
...
impl serde::Serialize for MsgDepositResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.MsgDepositResponse", len)?;
        struct_ser.end()
    }
}
#[cfg(feature = "serde")]
...
impl serde::Serialize for MsgSubmitProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.MsgSubmitProposal", len)?;
...
impl<'de> serde::Deserialize<'de> for MsgSubmitProposal {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["content", "initial_deposit", "initialDeposit", "proposer"];
...
impl<'de> serde::Deserialize<'de> for MsgVote {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["proposal_id", "proposalId", "voter", "option"];
...
impl<'de> serde::Deserialize<'de> for MsgVoteWeighted {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["proposal_id", "proposalId", "voter", "options"];
...
impl serde::Serialize for MsgVoteWeightedResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.MsgVoteWeightedResponse", len)?;
        struct_ser.end()
    }
}
#[cfg(feature = "serde")]
...
impl serde::Serialize for QueryDepositResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryDepositResponse", len)?;
...
impl serde::Serialize for QueryDepositsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryDepositsResponse", len)?;
        if !self.deposits.is_empty() {
            struct_ser.serialize_field("deposits", &self.deposits)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for QueryParamsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryParamsRequest", len)?;
        if !self.params_type.is_empty() {
...
impl serde::Serialize for QueryParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryParamsResponse", len)?;
        if let Some(v) = self.voting_params.as_ref() {
            struct_ser.serialize_field("votingParams", v)?;
        }
        if let Some(v) = self.deposit_params.as_ref() {
...
impl serde::Serialize for QueryProposalResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryProposalResponse", len)?;
...
impl serde::Serialize for QueryProposalsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryProposalsResponse", len)?;
        if !self.proposals.is_empty() {
            struct_ser.serialize_field("proposals", &self.proposals)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for QueryTallyResultResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryTallyResultResponse", len)?;
...
impl serde::Serialize for QueryVoteResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryVoteResponse", len)?;
...
impl serde::Serialize for QueryVotesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.gov.v1beta1.QueryVotesResponse", len)?;
        if !self.votes.is_empty() {
            struct_ser.serialize_field("votes", &self.votes)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for TallyResult {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["yes", "abstain", "no", "no_with_veto", "noWithVeto"];
...
impl<'de> serde::Deserialize<'de> for Vote {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["proposal_id", "proposalId", "voter", "option", "options"];

    ...
    */
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        */
        ...
        ) -> core::result::Result<tonic::Response<super::QueryEpochInfosResponse>, tonic::Status>
        {
            ...
            let path =
                http::uri::PathAndQuery::from_static("/cosmos.epochs.v1beta1.Query/EpochInfos");
        ...
        */
        ...
        ) -> core::result::Result<tonic::Response<super::QueryCurrentEpochResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/cosmos.epochs.v1beta1.Query/CurrentEpoch");
            let mut req = request.into_request();
...
pub mod query_server {
    ...
    */
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/cosmos.epochs.v1beta1.Query/EpochInfos" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryEpochInfosRequest> for EpochInfosSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut =
                                async move { <T as Query>::epoch_infos(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                ...
                "/cosmos.epochs.v1beta1.Query/CurrentEpoch" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryCurrentEpochRequest> for CurrentEpochSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as Query>::current_epoch(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "cosmos.epochs.v1beta1.Query";
    }
}

...
impl<'de> serde::Deserialize<'de> for Record {
    ...
    {
        const FIELDS: &[&str] = &[
            "name", "pub_key", "pubKey", "local", "ledger", "multi", "offline",
        ];
...
impl serde::Serialize for record::Ledger {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.crypto.keyring.v1.Record.Ledger", len)?;
...
impl serde::Serialize for record::Local {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("cosmos.crypto.keyring.v1.Record.Local", len)?;
...
impl<'de> serde::Deserialize<'de> for record::Local {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["priv_key", "privKey"];
...
impl serde::Serialize for record::Multi {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser =
            serializer.serialize_struct("cosmos.crypto.keyring.v1.Record.Multi", len)?;
        struct_ser.end()
    }
}
#[cfg(feature = "serde")]
...
impl serde::Serialize for record::Offline {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser =
            serializer.serialize_struct("cosmos.crypto.keyring.v1.Record.Offline", len)?;
        struct_ser.end()
    }
}
#[cfg(feature = "serde")]

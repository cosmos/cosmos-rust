...
impl<'de> serde::Deserialize<'de> for MsgModuleQuerySafe {
    ...
    {
        const FIELDS: &[&str] = &["signer", "requests"];
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str(
                    "struct ibc.applications.interchain_accounts.host.v1.MsgModuleQuerySafe",
                )
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MsgModuleQuerySafe, V::Error>
            where
...
impl<'de> serde::Deserialize<'de> for MsgModuleQuerySafeResponse {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["height", "responses"];
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map_: V,
            ) -> std::result::Result<MsgModuleQuerySafeResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for MsgUpdateParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str(
                    "struct ibc.applications.interchain_accounts.host.v1.MsgUpdateParams",
                )
            }
...
impl<'de> serde::Deserialize<'de> for MsgUpdateParamsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str(
                    "struct ibc.applications.interchain_accounts.host.v1.MsgUpdateParamsResponse",
                )
            }
...
impl<'de> serde::Deserialize<'de> for QueryRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter
                    .write_str("struct ibc.applications.interchain_accounts.host.v1.QueryRequest")
            }

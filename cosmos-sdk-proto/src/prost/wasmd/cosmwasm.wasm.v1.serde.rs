impl serde::Serialize for AbsoluteTxPosition {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.AbsoluteTxPosition", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("blockHeight", ::alloc::string::ToString::to_string(&self.block_height).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
...
impl<'de> serde::Deserialize<'de> for AbsoluteTxPosition {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.AbsoluteTxPosition", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AccessConfig {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            let v = AccessType::try_from(self.permission)
                .map_err(|_| serde::ser::Error::custom(::alloc::format!("Invalid variant {}", self.permission)))?;
...
impl serde::Serialize for AccessConfigUpdate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.AccessConfigUpdate", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("codeId", ::alloc::string::ToString::to_string(&self.code_id).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for AccessConfigUpdate {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "instantiatePermission" | "instantiate_permission" => Ok(GeneratedField::InstantiatePermission),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
                    ...
                    match k {
                        ...
                        GeneratedField::InstantiatePermission => {
                            if instantiate_permission__.is_some() {
                                return Err(serde::de::Error::duplicate_field("instantiatePermission"));
                            }
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.AccessConfigUpdate", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for AccessTypeParam {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.AccessTypeParam", len)?;
        if true {
            let v = AccessType::try_from(self.value)
                .map_err(|_| serde::ser::Error::custom(::alloc::format!("Invalid variant {}", self.value)))?;
...
impl<'de> serde::Deserialize<'de> for AccessTypeParam {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.AccessTypeParam", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ClearAdminProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.ClearAdminProposal", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for ClearAdminProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.ClearAdminProposal", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for CodeInfo {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("codeHash", pbjson::private::base64::encode(&self.code_hash).as_str())?;
        }
        if true {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "instantiateConfig" | "instantiate_config" => Ok(GeneratedField::InstantiateConfig),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
impl serde::Serialize for CodeInfoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.CodeInfoResponse", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("codeId", ::alloc::string::ToString::to_string(&self.code_id).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for CodeInfoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.CodeInfoResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ContractCodeHistoryEntry {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.ContractCodeHistoryEntry", len)?;
        if true {
            let v = ContractCodeHistoryOperationType::try_from(self.operation)
                .map_err(|_| serde::ser::Error::custom(::alloc::format!("Invalid variant {}", self.operation)))?;
...
impl<'de> serde::Deserialize<'de> for ContractCodeHistoryEntry {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<ContractCodeHistoryEntry, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Operation => {
                            ...
                            operation__ = Some(map_.next_value::<ContractCodeHistoryOperationType>()? as i32);
                        }
                        GeneratedField::CodeId => {
                            if code_id__.is_some() {
                                return Err(serde::de::Error::duplicate_field("codeId"));
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.ContractCodeHistoryEntry", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for ContractCodeHistoryOperationType {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            {
                match value {
                    "CONTRACT_CODE_HISTORY_OPERATION_TYPE_UNSPECIFIED" => Ok(ContractCodeHistoryOperationType::Unspecified),
                    "CONTRACT_CODE_HISTORY_OPERATION_TYPE_INIT" => Ok(ContractCodeHistoryOperationType::Init),
                    "CONTRACT_CODE_HISTORY_OPERATION_TYPE_MIGRATE" => Ok(ContractCodeHistoryOperationType::Migrate),
                    "CONTRACT_CODE_HISTORY_OPERATION_TYPE_GENESIS" => Ok(ContractCodeHistoryOperationType::Genesis),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
...
impl serde::Serialize for ExecuteContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.ExecuteContractProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for ExecuteContractProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<ExecuteContractProposal, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.ExecuteContractProposal", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for genesis_state::GenMsgs {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.GenesisState.GenMsgs", len)?;
...
impl<'de> serde::Deserialize<'de> for genesis_state::GenMsgs {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "instantiateContract" | "instantiate_contract" => Ok(GeneratedField::InstantiateContract),
                            "executeContract" | "execute_contract" => Ok(GeneratedField::ExecuteContract),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<genesis_state::GenMsgs, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut sum__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::StoreCode => {
                            ...
                            sum__ = map_.next_value::<::core::option::Option<_>>()?.map(genesis_state::gen_msgs::Sum::StoreCode)
;
                        }
                        GeneratedField::InstantiateContract => {
                            if sum__.is_some() {
                                return Err(serde::de::Error::duplicate_field("instantiateContract"));
                            }
                            sum__ = map_.next_value::<::core::option::Option<_>>()?.map(genesis_state::gen_msgs::Sum::InstantiateContract)
;
                        }
                        GeneratedField::ExecuteContract => {
                            ...
                            sum__ = map_.next_value::<::core::option::Option<_>>()?.map(genesis_state::gen_msgs::Sum::ExecuteContract)
;
                        }
                    }
                }
                Ok(genesis_state::GenMsgs {
                    sum: sum__,
                })
            }
        }
        deserializer.deserialize_struct("cosmwasm.wasm.v1.GenesisState.GenMsgs", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for InstantiateContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.InstantiateContractProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for InstantiateContractProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<InstantiateContractProposal, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.InstantiateContractProposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MigrateContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MigrateContractProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for MigrateContractProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MigrateContractProposal, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MigrateContractProposal", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MsgClearAdminResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgClearAdminResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgClearAdminResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgClearAdminResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgClearAdminResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgExecuteContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgExecuteContract", len)?;
        if true {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for MsgExecuteContract {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgExecuteContract", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgExecuteContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgExecuteContractResponse", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
...
impl<'de> serde::Deserialize<'de> for MsgExecuteContractResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgExecuteContractResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut data__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgExecuteContractResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgIbcCloseChannel {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgIBCCloseChannel", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for MsgIbcCloseChannel {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgIBCCloseChannel", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgIbcSend {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("timeoutHeight", ::alloc::string::ToString::to_string(&self.timeout_height).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
...
impl serde::Serialize for MsgInstantiateContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract", len)?;
        if true {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for MsgInstantiateContract {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgInstantiateContract, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgInstantiateContract2 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract2", len)?;
        if true {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for MsgInstantiateContract2 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgInstantiateContract2, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract2", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgInstantiateContract2Response {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract2Response", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for MsgInstantiateContract2Response {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgInstantiateContract2Response, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract2Response", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgInstantiateContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContractResponse", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for MsgInstantiateContractResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgInstantiateContractResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgInstantiateContractResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgMigrateContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgMigrateContract", len)?;
        if true {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for MsgMigrateContract {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgMigrateContract", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgMigrateContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgMigrateContractResponse", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("data", pbjson::private::base64::encode(&self.data).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for MsgMigrateContractResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgMigrateContractResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MsgStoreCodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgStoreCodeResponse", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("codeId", ::alloc::string::ToString::to_string(&self.code_id).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for MsgStoreCodeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgStoreCodeResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MsgUpdateAdminResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.MsgUpdateAdminResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgUpdateAdminResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<MsgUpdateAdminResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.MsgUpdateAdminResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            let v = AccessType::try_from(self.instantiate_default_permission)
                .map_err(|_| serde::ser::Error::custom(::alloc::format!("Invalid variant {}", self.instantiate_default_permission)))?;
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "codeUploadAccess" | "code_upload_access" => Ok(GeneratedField::CodeUploadAccess),
                            "instantiateDefaultPermission" | "instantiate_default_permission" => Ok(GeneratedField::InstantiateDefaultPermission),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
                    ...
                    match k {
                        ...
                        GeneratedField::InstantiateDefaultPermission => {
                            if instantiate_default_permission__.is_some() {
                                return Err(serde::de::Error::duplicate_field("instantiateDefaultPermission"));
                            }
                            instantiate_default_permission__ = Some(map_.next_value::<AccessType>()? as i32);
                        }
                    }
                }
                Ok(Params {
                    code_upload_access: code_upload_access__,
                    instantiate_default_permission: instantiate_default_permission__.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for PinCodesProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.PinCodesProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
        ...
        if true {
            struct_ser.serialize_field("codeIds", &self.code_ids.iter().map(::alloc::string::ToString::to_string).collect::<::alloc::vec::Vec<_>>())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PinCodesProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.PinCodesProposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryAllContractStateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryAllContractStateRequest", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
...
impl<'de> serde::Deserialize<'de> for QueryAllContractStateRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryAllContractStateRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryAllContractStateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryAllContractStateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryAllContractStateResponse", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for QueryAllContractStateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryAllContractStateResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryAllContractStateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCodeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryCodeRequest", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("codeId", ::alloc::string::ToString::to_string(&self.code_id).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for QueryCodeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryCodeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryCodeResponse", len)?;
        if let Some(v) = self.code_info.as_ref() {
            struct_ser.serialize_field("codeInfo", v)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for QueryCodeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryCodeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCodesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryCodesRequest", len)?;
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for QueryCodesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryCodesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCodesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryCodesResponse", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for QueryCodesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryCodesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryContractHistoryRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryContractHistoryRequest", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryContractHistoryRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryContractHistoryRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryContractHistoryRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryContractHistoryResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryContractHistoryResponse", len)?;
        if true {
...
impl<'de> serde::Deserialize<'de> for QueryContractHistoryResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryContractHistoryResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryContractHistoryResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryContractInfoRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryContractInfoRequest", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for QueryContractInfoRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryContractInfoRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryContractInfoRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryContractInfoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryContractInfoResponse", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if let Some(v) = self.contract_info.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryContractInfoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryContractInfoResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryContractInfoResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryContractsByCodeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryContractsByCodeRequest", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("codeId", ::alloc::string::ToString::to_string(&self.code_id).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for QueryContractsByCodeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryContractsByCodeRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut code_id__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryContractsByCodeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryContractsByCodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryContractsByCodeResponse", len)?;
        if true {
            struct_ser.serialize_field("contracts", &self.contracts)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryContractsByCodeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryContractsByCodeResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut contracts__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryContractsByCodeResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for QueryParamsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryParamsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryParamsResponse", len)?;
        if let Some(v) = self.params.as_ref() {
            struct_ser.serialize_field("params", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for QueryParamsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryParamsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPinnedCodesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryPinnedCodesRequest", len)?;
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for QueryPinnedCodesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryPinnedCodesRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut pagination__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryPinnedCodesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPinnedCodesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryPinnedCodesResponse", len)?;
        if true {
            struct_ser.serialize_field("codeIds", &self.code_ids.iter().map(::alloc::string::ToString::to_string).collect::<::alloc::vec::Vec<_>>())?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryPinnedCodesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryPinnedCodesResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut code_ids__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryPinnedCodesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryRawContractStateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryRawContractStateRequest", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("queryData", pbjson::private::base64::encode(&self.query_data).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for QueryRawContractStateRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryRawContractStateRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryRawContractStateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryRawContractStateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QueryRawContractStateResponse", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("data", pbjson::private::base64::encode(&self.data).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for QueryRawContractStateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QueryRawContractStateResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut data__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QueryRawContractStateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QuerySmartContractStateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QuerySmartContractStateRequest", len)?;
        if true {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for QuerySmartContractStateRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QuerySmartContractStateRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QuerySmartContractStateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QuerySmartContractStateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.QuerySmartContractStateResponse", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("data", pbjson::private::base64::encode(&self.data).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for QuerySmartContractStateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<QuerySmartContractStateResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut data__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.QuerySmartContractStateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Sequence {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("idKey", pbjson::private::base64::encode(&self.id_key).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
...
impl serde::Serialize for StoreCodeProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.StoreCodeProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for StoreCodeProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.StoreCodeProposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SudoContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.SudoContractProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for SudoContractProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<SudoContractProposal, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.SudoContractProposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UnpinCodesProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.UnpinCodesProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for UnpinCodesProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.UnpinCodesProposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UpdateAdminProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.UpdateAdminProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for UpdateAdminProposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<UpdateAdminProposal, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.UpdateAdminProposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UpdateInstantiateConfigProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmwasm.wasm.v1.UpdateInstantiateConfigProposal", len)?;
        if true {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for UpdateInstantiateConfigProposal {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "title" => Ok(GeneratedField::Title),
                            "description" => Ok(GeneratedField::Description),
                            "accessConfigUpdates" | "access_config_updates" => Ok(GeneratedField::AccessConfigUpdates),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> core::result::Result<UpdateInstantiateConfigProposal, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
                    ...
                    match k {
                        ...
                        GeneratedField::AccessConfigUpdates => {
                            if access_config_updates__.is_some() {
                                return Err(serde::de::Error::duplicate_field("accessConfigUpdates"));
                            }
        ...
        deserializer.deserialize_struct("cosmwasm.wasm.v1.UpdateInstantiateConfigProposal", FIELDS, GeneratedVisitor)
    }
}
